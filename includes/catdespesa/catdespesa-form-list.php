...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      &nbsp;
                       <a href="catdespesas-delete.php?id=' . $item->id . '">
...
<div class="modal fade" id="modal-default">
   <div class="modal-dialog">
      <div class="modal-content bg-light">
         <form action="./catdespesas-insert.php" method="post">

            <div class="modal-header">
               <h4 class="modal-title">Nova Despesa
               </h4>
...
<form action="./catdespesas-edit.php" method="GET">
